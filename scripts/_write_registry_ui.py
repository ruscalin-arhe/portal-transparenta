...
Path("src/app/(admin)/admin/registry/page.tsx").write_text(r'''"use client";
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          Organization / DataSource / DataRun — create + list (channel doar in DB)
        </p>
      </div>
...
''')
print("OK", Path("src/app/(admin)/admin/registry/page.tsx").stat().st_size)
